...
const currentMonthTotalAmount = computed<TransactionListDisplayTotalAmount | null>(() => {
    ...
    if (queryMonthlyData.value) {
        ...
        return {
            income: getDisplayCurrencyTotalAmounts(transactionData.totalAmountByCurrency.income, 'income'),
            expense: getDisplayCurrencyTotalAmounts(transactionData.totalAmountByCurrency.expense, 'expense')
        };
    } else {
...
function calculateDisplayTotalAmountByTransactions(allTransactions: Transaction[]): { income: TransactionCurrencyAmount[]; expense: TransactionCurrencyAmount[] } {
    ...
    for (const transaction of allTransactions) {
        ...
        let currency = transaction.sourceAccount?.currency || defaultCurrency.value;
